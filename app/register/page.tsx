...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Aquí iría la lógica para registrar la empresa
        ...
        <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center p-4">
          <Card className="w-full max-w-md border-transparent shadow-xl">
            <CardHeader className="space-y-1">
              ...
              <CardTitle className="text-2xl text-center font-bold">Registro de empresa</CardTitle>
              <CardDescription className="text-center">Cree una cuenta para comenzar a usar EvalPro</CardDescription>
            </CardHeader>
